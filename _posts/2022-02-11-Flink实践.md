...
<img title="2022-02-11-Flink实践-1.png" src="/images/2022-02-11-Flink实践.png" width="1920" />

<span class="caption">观测到Flink job聚合的数据有两次骤降</span>

碰到过一个问题，在某段时间Flink job sink的结果突然骤降，然后过了几个小时又恢复了正常。观察consumer lag也是类似的情况：

<img title="2022-02-11-Flink实践-2.png" src="/images/2022-02-11-Flink实践.png" width="1920" />
